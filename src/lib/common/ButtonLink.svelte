...
<a
  ...
  class="
    ...
    justify-{justifyContent} relative inline-flex w-full cursor-pointer items-center gap-x-3 rounded-md border-0 px-3 py-2 text-base shadow-sm ring-1 outline-2 outline-offset-2 outline-transparent ring-inset"
>
  {#if badge && !primary}
    <span
